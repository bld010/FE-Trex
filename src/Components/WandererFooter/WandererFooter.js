  ...
  render() {
    return (
      <View style={styles.footer}>
        <TouchableOpacity onPress={() => this.props.navigate("MyTrips")}>
          <Text style={styles.footerText}>Trips</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => this.props.navigate("SafetyInfo")}>
          <Text style={styles.footerText}>Safety</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => this.props.navigate("MyFollowers")}>
